...
# --- 2. AS65351 (172.17.35.0/24) ---
echo "Configuring AS65351 (h3 and r1/frr1)..."
# h3 (172.17.35.2/24) - Direct veth connection
# Interface name is eth0 (set by create.sh)
dexec h3 ip addr add 172.17.35.2/24 dev eth0
# Set up a default route to r1 (172.17.35.1)
dexec h3 ip route replace default via 172.17.35.1

# r1 (frr1) Intra-AS IP (172.17.35.1/24) - Direct veth connection
# Interface name is eth1 (set by create.sh)
dexec frr1 ip addr add 172.17.35.1/24 dev eth1

# --- 3. AS65350 (172.16.35.0/24 and 192.168.100.0/24) ---
...
# h2 (172.16.35.3/24)
dexec h2 ip addr add 172.16.35.3/24 dev eth0
dexec h2 ip route replace default via 172.16.35.1 # Default route to vrouter virtual gateway

# h1 (172.16.35.2/24)
dexec h1 ip addr add 172.16.35.2/24 dev eth0
dexec h1 ip route replace default via 172.16.35.1 # Default route to vrouter virtual gateway
...
dexec frr0 ip addr add 172.16.35.69/24 dev ${R0_IF_OVS1}
dexec frr0 ip addr add 192.168.100.3/24 dev ${R0_IF_OVS1}
dexec frr0 ip addr add 192.168.70.35/24 dev ${R0_IF_OVS1}  # For VXLAN to ovs3
...
# h3 (2a0b:4e07:c4:135::2/64) -> GW: frr1 (2a0b:4e07:c4:135::1)
dexec h3 ip -6 addr add 2a0b:4e07:c4:135::2/64 dev eth0
dexec h3 ip -6 route replace default via 2a0b:4e07:c4:135::1

# frr1 (2a0b:4e07:c4:135::1/64, fd63::2/64)
# eth1 faces h3, eth0 faces ovs1(frr0)
dexec frr1 ip -6 addr add 2a0b:4e07:c4:135::1/64 dev eth1
dexec frr1 ip -6 addr add fd63::2/64 dev eth0

# h2 (2a0b:4e07:c4:35::3/64) -> GW: vrouter (2a0b:4e07:c4:35::1)
dexec h2 ip -6 addr add 2a0b:4e07:c4:35::3/64 dev eth0
dexec h2 ip -6 route replace default via 2a0b:4e07:c4:35::1

# h1 (2a0b:4e07:c4:35::2/64) -> GW: vrouter (2a0b:4e07:c4:35::1)
dexec h1 ip -6 addr add 2a0b:4e07:c4:35::2/64 dev eth0
dexec h1 ip -6 route replace default via 2a0b:4e07:c4:35::1

# frr0 (fd63::1/64, fd70::35/64, 2a0b:4e07:c4:35::69/64)
# All on eth0 (connected to ovs1)
dexec frr0 ip -6 addr add fd63::1/64 dev eth0
dexec frr0 ip -6 addr add fd70::35/64 dev eth0
dexec frr0 ip -6 addr add 2a0b:4e07:c4:35::69/64 dev eth0