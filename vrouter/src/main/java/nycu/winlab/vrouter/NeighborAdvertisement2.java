 ...
 */
public class NeighborAdvertisement2 extends BasePacket {
    public static final byte HEADER_LENGTH = 20; // bytes
    // Constants for NDP reply
    protected static final byte NDP_HOP_LIMIT = (byte) 0xFF;
     ...
     * @return this
     */
    public NeighborAdvertisement2 setRouterFlag(final byte routerFlag) {
     ...
     * @return this
     */
    public NeighborAdvertisement2 setSolicitedFlag(final byte solicitedFlag) {
     ...
     * @return this
     */
    public NeighborAdvertisement2 setOverrideFlag(final byte overrideFlag) {
     ...
     * @return this
     */
    public NeighborAdvertisement2 setTargetAddress(final byte[] targetAddress) {
        this.targetAddress =
     ...
     * @return this
     */
    public NeighborAdvertisement2 addOption(final byte type,
                                          final byte[] data) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof NeighborAdvertisement2)) {
            return false;
        }
        final NeighborAdvertisement2 other = (NeighborAdvertisement2) obj;
     ...
     */
    public static Deserializer<NeighborAdvertisement2> deserializer() {
        return (data, offset, length) -> {
            checkInput(data, offset, length, HEADER_LENGTH);

            NeighborAdvertisement2 neighborAdvertisement = new NeighborAdvertisement2();
    ...
    public static Ethernet buildNdpAdv(Ip6Address srcIp,
        ...
        NeighborAdvertisement2 nadv = new NeighborAdvertisement2();
